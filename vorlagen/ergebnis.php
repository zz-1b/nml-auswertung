...
class ErgebnisTabelle
{
	...
	$this->spaltennamen=array("Nachname","Vorname","Jahrgang","Geschlecht","Verein","Zeit","Serienteilnahme");
    }
    ...
    {
	$sql = $this->dbh->prepare("INSERT INTO ergebnisse (datensatzid, nachname, vorname, jahrgang, geschlecht, verein, zeit, serienteilnahme)
                                    VALUES (:datensatzid, :nachname, :vorname, :jahrgang, :geschlecht, :verein, :zeit, :serienteilnahme)");
	...
	$serienteilnahme = strtr($zeile[$this->spaltenindizes["Serienteilnahme"]],"jn","01");
	if(strlen($serienteilnahme)!=1 || ($serienteilnahme!="0" && $serienteilnahme !="1"))
	    throw new \Exception("Formatfehler: Serienteilnahme muß als ein Zeichen (j/n oder 1/0) angegeben werden.");
